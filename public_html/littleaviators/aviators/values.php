<?
	$page="aviators_values";
	$heroimg="none";
	include("../geokids.php");
	include("../content/pagetop.inc");
?>

<h2>GeoKids Values</h2>

<p>GeoKids believes that children, families, teachers and the community at large can work together as resources to develop curriculum. It is the belief at GeoKids that we are not preparing children specifically for kindergarten, but to have a life long love of learning. We offer a curriculum that challenges, encourages, and supports children in their quest for knowledge, recognizing the developmental stages of childhood and the unique gifts, talents and abilities of each child.</p>

<p>GeoKids is inspired by the Reggio Emilia approach, which encourages children's intellectual development through systematic focus on symbolic representation, as children are encouraged to explore their environment and express themselves through words, movement, drawing, painting, playing, and other natural modes of expression.</p>

<p>Through daily observations, the teaching staff can pay close attention to recurring themes in the children's play, developmental issues, testing of hypotheses and theories, which is the foundation of the Emergent Curriculum practiced at GeoKids.</p>

<p>It is the belief at GeoKids that strong, rich, and meaningful curriculum is developed as relationships are developed. At GeoKids, we value the following relationships:
<ul>
